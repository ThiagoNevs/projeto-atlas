...
- Importação de ativos por CSV, XLSX, XLSM ou conteúdo colado, como declaração manual controlada, exigindo `hostname` e `ipAddress`; macros e fórmulas nunca são executadas.
