...
- [ADR-013 — Autenticação de Service Actors](013-service-actor-authentication.md) — Proposed — identidade machine-to-machine ainda não escolhida.
...
- **Antes de Service Actors:** decisão de identidade/autenticação, secrets e rotação, permissions de serviço, política de auditoria e threat model.
