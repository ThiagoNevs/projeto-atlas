...
export class CreateFindingReviewDecisionSupersessionDto {
  ...
  @Max(MAX_UPDATABLE_FINDING_REVIEW_CASE_VERSION, {
    message: 'expectedVersion excede o limite persistível para uma correção de decisão.',
  })
  ...
  @ValidateIf((_object, value) => value !== undefined)
  @IsString({ message: 'correctionReason deve ser uma string.' })
